...
use crate::si::thermal::temperature_interval::TemperatureInterval;
...
macro_rules! impl_ops {
    (
        ...
        where
            Ul: crate::si::Units<V> + ?Sized,
            Ur: crate::si::Units<V> + ?Sized,
            V: $crate::num::Num + $crate::Conversion<V>,
        {
            ...
            fn $addsub_fun(self, rhs: TemperatureInterval<Ur, V>) -> Self::Output {
                crate::si::Quantity {
                    ...
                    value: self.value
                        $addsub_op crate::si::change_base::<Dimension, Ul, Ur, V>(&rhs.value),
                }
            }
        }
            ...
            V: $crate::num::Num + $crate::Conversion<V> + $crate::lib::ops::$AddSubAssignTrait<V>,
        {
            ...
            fn $addsubassign_fun(&mut self, rhs: TemperatureInterval<Ur, V>) {
                self.value $addsubassign_op crate::si::change_base::<Dimension, Ul, Ur, V>(&rhs.value);
            }
        }
...
#[cfg(test)]
mod tests {
    use crate::si::quantities::thermal::*;
    use crate::si::thermal::temperature_interval as ti;
    use crate::si::thermal::thermodynamic_temperature as tt;
