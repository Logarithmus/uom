...
mod tests {
    storage_types! {
        use crate::num::One;
        use crate::si::chemistry::{amount_of_substance as a, molar_heat_capacity as m};
        use crate::si::energy::energy as e;
        use crate::si::thermal::temperature_interval as t;
        use crate::si::quantities::{
            chemistry::{AmountOfSubstance, MolarHeatCapacity},
            energy::Energy,
            thermal::TemperatureInterval,
        };
